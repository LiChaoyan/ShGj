                ...
                <div class="navbar">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="<%= request.getContextPath()%>">
                            <i class="text-logo-element animated bounceIn"></i><span class="text-logo">校园</span><span class="text-slogan">大数据</span> 
                        </a>
                    </div>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="<%= request.getContextPath()%>/views/biao_map3.jsp"><i class="im-airplane"></i>迁徙图</a>
                    </li>
                     <!-- <li><a href="<%= request.getContextPath()%>/views/dian.jsp"><i class="im-fire"></i> 散点图分布</a>
                     </li> -->
                  <!--    <li><a href="<%= request.getContextPath()%>/views/remap.jsp"><i class="im-fire"></i> 热力图分布</a>
                     </li> -->
                     <li><a href="<%= request.getContextPath()%>/views/kmap.jsp"><i class="im-fire"></i> 热力图分布</a>
                     </li>
                    <li><a href="<%= request.getContextPath()%>/views/xs.jsp"><i class="im-paragraph-justify"></i>相似推荐</a>
                    </li>
                    
                    <li>
                        <a href="<%= request.getContextPath()%>/views/time-bin.jsp">时空分布<i class="st-grid"></i></a>
                    </li>
                   
                   
                    
                    <li><a href="<%= request.getContextPath()%>/views/cen.jsp">楼层图<i class="im-stack"></i></a>
                    </li>
                    
                 
                    <li><a href="<%= request.getContextPath()%>/views/yibiao"><i class="st-chart"></i>归寝率</a>
                    </li>
             </ul>
            </div> 
            <!-- End .sidebar-inner -->
